...
public final class Constants {
  ...
  public static final Set<String> AUDIO_EXTENSIONS =
      Set.of("mp3", "wav", "ogg", "flac", "aac", "wma", "m4a", "ac3");
  public static final Set<String> IMAGE_EXTENSIONS =
      Set.of("jpg", "jpeg", "png", "bmp", "gif", "webp", "tiff", "ico", "psd", "raw", "svg");
  public static final Set<String> DOCUMENT_EXTENSIONS =
      Set.of("pdf", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "odt", "ods", "odp", "rtf");
  public static final Set<String> ARCHIVE_EXTENSIONS =
      Set.of("zip", "rar", "tar", "gz", "7z", "bz2", "xz");
  public static final Set<String> PREVIEWABLE_EXTENSIONS =
      Collections.unmodifiableSet(
          Stream.of(VIDEO_EXTENSIONS, AUDIO_EXTENSIONS, IMAGE_EXTENSIONS)
              .flatMap(Collection::stream)
              .collect(Collectors.toSet()));

  public static final Set<String> NON_PREVIEWABLE_EXTENSIONS =
      Collections.unmodifiableSet(
  ...
  public static final String GITHUB_URL =
      GITHUB_BASE_URL.concat("/").concat(REPO_ADMIN_USER_NAME).concat(REPO_NAME);
  ...
  public static final String DEBUG_LOGGING_PATH_CUE =
      "Documents" + File.separator + APP_PACKAGE_NAME;
