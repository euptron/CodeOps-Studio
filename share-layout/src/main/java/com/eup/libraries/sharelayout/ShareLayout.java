...
/**
 * A ShareLayout is a derivative of {@link LinearLayout} that displays information to the user. To
 ...
 * <pre>
 * &lt;LinearLayout
 *        xmlns:android="<a href="http://schemas.android.com/apk/res/android">...</a>"
...
public class ShareLayout extends LinearLayout {
    ...
    private int shareActionsCornerRadius;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        String actionText;
        int elevation;
        int titleTextAppearanceResId;
        int summaryTextAppearanceResId;
        int promptTextAppearanceResId;
        int actionTextAppearanceResId;
        try {
            ...
            titleTextAppearanceResId   =
                a.getResourceId(R.styleable.ShareLayout_titleTextAppearance, 0);
            summaryTextAppearanceResId =
                a.getResourceId(R.styleable.ShareLayout_summaryTextAppearance, 0);
            promptTextAppearanceResId  =
                a.getResourceId(R.styleable.ShareLayout_promptTextAppearance, 0);
        ...
        shareLinear.addView(title, uiBuilder.createLinear(WRAP_CONTENT, WRAP_CONTENT,
            Gravity.START));
        ...
        shareLinear.addView(summary, uiBuilder.createLinear(WRAP_CONTENT, WRAP_CONTENT,
            Gravity.START));
        ...
        shareContainer.addView(sharePrompt, uiBuilder.createLinear(MATCH_PARENT, MATCH_PARENT,
        ...
        shareContainer.addView(progressBar, uiBuilder.createLinear(WRAP_CONTENT, MATCH_PARENT,
            Gravity.CENTER));
        progressBar.setPadding(dp(5), dp(5), dp(5), dp(5));
        progressBar.setBackgroundColor(Color.TRANSPARENT);
        shareContainer.addView(shareButton, uiBuilder.createLinear(WRAP_CONTENT, 40,
            Gravity.CENTER));
