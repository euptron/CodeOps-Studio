...
public class ContextualCompletionItem extends SimpleCompletionItem {
     ...
     */
    @Nullable
    public CharSequence compDescription;
    ...
    public ContextualCompletionItem(CharSequence label, CharSequence desc, int prefixLength,
        String commitText) {
        this(label, desc, null, prefixLength, commitText);
    }

    public ContextualCompletionItem(CharSequence label, CharSequence desc, CharSequence compDes,
        int prefixLength, String commitText) {
        this(label, desc, null, compDes, prefixLength, commitText);
    }

    public ContextualCompletionItem(CharSequence label, CharSequence desc, Drawable icon,
        @Nullable CharSequence compDes, int prefixLength, String commitText) {
