...
public class Wizard {
    ...
    public static String getAppName(Context context) {
        ...
        try {
            ...
            var param = appInfo == null ? null : (String) appInfo.loadLabel(packageManager);
    ...
    public String getMimeType(Context context, Uri uri) {
        ...
        var file = new File(Objects.requireNonNull(uri.getPath()));
    ...
    public static void installApplication(Context context, Uri uri, Runnable action) {
        ...
        BroadcastReceiver packageAddedReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                var intentUri = intent.getData();
                if (intentUri == null) { return; }

                String installedPackage = intentUri.getSchemeSpecificPart();
    ...
    public static boolean allNotNull(Object... obs) {
        for (Object obj : obs) {
    ...
    public static boolean isStoragePermissionGranted(Context context) {
        return (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R)
            ? isStoragePermissionGrantedApi30(context) : isStoragePermissionGrantedApi19(context);
    }
    ...
    private static boolean isStoragePermissionGrantedApi19(Context context) {
        int readStatus = ContextCompat.checkSelfPermission(context,
            Manifest.permission.READ_EXTERNAL_STORAGE);
        int writeStatus = ContextCompat.checkSelfPermission(context,
    ...
    public static void requestStoragePermissionApi30(Context context,
        ...
        try {
            ...
            ILog.error(LOG_TAG, "ACTION_MANAGE_APP_ALL_FILES_ACCESS_PERMISSION not found, trying "
                + "fallback", ante);
            try {
    ...
    public static boolean isNotificationPermissionGranted(Context context) {
        int grantStatus = ContextCompat.checkSelfPermission(context,
