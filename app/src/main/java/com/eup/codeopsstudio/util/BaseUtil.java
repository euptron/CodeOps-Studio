...
public class BaseUtil {
    ...
    public static void toastLong(final @StringRes int stringRes) {
        AsyncTask.runOnUiThread(() -> Toast
            .makeText(IdeApplication.getGlobalContext(), stringRes, Toast.LENGTH_LONG)
            .show());
    }

    public static int getRowCount(int itemWidth) {
        DisplayMetrics displayMetrics = IdeApplication
            .getGlobalResources()
            .getDisplayMetrics();
    ...
    public static void expand(final View v) {
        ...
        a.setDuration((int) (targetHeight / v
            .getContext()
            .getResources()
    ...
    public static void collapse(final View v) {
        ...
        a.setDuration((int) (initialHeight / v
            .getContext()
            .getResources()
            .getDisplayMetrics().density) / 2);
        v.startAnimation(a);
    ...
    public static void toastShort(final @StringRes int stringRes) {
        AsyncTask.runOnUiThread(() -> Toast
            .makeText(IdeApplication.getGlobalContext(), stringRes, Toast.LENGTH_SHORT)
            .show());
    }
    ...
    public static void shareAppPlayStoreLink() {
        ...
        String appName = IdeApplication
            .getGlobalContext()
            .getString(R.string.app_name);
        shareIntent.setChooserTitle(appName);
        shareIntent.setText(IdeApplication
            .getGlobalContext()
    ...
    public static void toastShort(final String message) {
        AsyncTask.runOnUiThread(() -> Toast
            .makeText(IdeApplication.getGlobalContext(), message, Toast.LENGTH_SHORT)
            .show());
    }
    ...
    public static void toastLong(final String message) {
        AsyncTask.runOnUiThread(() -> Toast
            .makeText(IdeApplication.getGlobalContext(), message, Toast.LENGTH_LONG)
            .show());
    }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        var imm = (InputMethodManager) IdeApplication
            .getInstance()
    ...
    public static void toggleSoftInput() {
        InputMethodManager imm = (InputMethodManager) IdeApplication
            .getInstance()
            .getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
