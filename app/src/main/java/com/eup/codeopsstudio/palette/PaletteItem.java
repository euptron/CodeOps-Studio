...
public class PaletteItem {
    ...
    public PaletteItem(String id, String title, String subtitle, String tag, String shortcut,
        Runnable action) {
        this.id       = id;
    ...
    public static final DiffUtil.ItemCallback<PaletteItem> DIFF_CALLBACK =
        ...
        @Override
        public boolean areContentsTheSame(@NonNull PaletteItem oldItem,
            @NonNull PaletteItem newItem) {
