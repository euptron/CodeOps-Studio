...
public class EditorManager {
    ...
    public static class JsonBuilder {
        ...
        private final HashMap<String, Object> startSelectionMap = new HashMap<>();
        private final HashMap<String, Object> endSelectionMap = new HashMap<>();
        ...
        public JsonBuilder addCodeEditor(String id, StartSelection startSelection,
            ...
            selectionMap.put("launchWithLocalHost", startSelectionMap);
        ...
        public String prettyPrintJson(String jsonString) {
            ...
            prettyPrintJsonAsync(jsonString, new AsyncTask.Callback<String>() {
                @Override
        ...
        private String prettyPrintJsonAsync(String jsonString,
