...
public class TreeNode {
    ...
    private static final Comparator<TreeNode> DIR_SORT = (node1, node2) -> {
        File a = node1.getValue();
        File b = node2.getValue();
        return getType(a) - getType(b);
    };
    private static final Comparator<TreeNode> NAME_SORT = (node1, node2) -> {
        File a = node1.getValue();
        File b = node2.getValue();
    ...
    public List<TreeNode> getChildren() {
        return children == null ? Collections.synchronizedList(new ArrayList<TreeNode>())
            : children;
    }
