...
import com.eup.codeopsstudio.tv.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    private static void collapse(final View v) {
        ...
        // 1dp/ms
        a.setDuration((int) (
            (initialHeight / v.getContext().getResources().getDisplayMetrics().density) / 2));
        v.startAnimation(a);
    }
    ...
    private static void expand(final View v) {
        ...
        // 1dp/ms
        a.setDuration((int) (
            (targetHeight / v.getContext().getResources().getDisplayMetrics().density) / 2));
        v.startAnimation(a);
    }
